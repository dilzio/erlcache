...
start_link(Callback, IP, Port, UserArgs) ->
    error_logger:info_msg("Got to gen_web_server:start_link/4 Callback:~p IP:~p Port:~p UserArgs:~p ~n", [Callback, IP, Port, UserArgs]),
...
http_reply(Code, Body) ->
    http_reply(Code,[{"Content_Type", "text/html"}],Body). 
